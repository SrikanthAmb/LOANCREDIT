...
-----------------------------------------------
git clone https://github.com/SrikanthAmb/LOANCREDIT.git

Place all the files like csv file, ipynb file, app.py files in folder "LOANCREDIT" file created by github clone command.
...
`````````````````````````
conda create -p credit python==3.10 -y

Activate the new Environment
------------------------------
conda activate file/path/to/credit
...
Test the app file
-------------------
Type "python app.py" in cmd prompt, with which a https link is triggered and displayed. 
Copying and pasting the link in the browser's search bar, web page is displayed. 
If no errors found on submitting values and displaying desired ouput, 
then we can proceed to Heroku for deployment.
...
Deployment
-------------
Connect to github repository "LOANCREDIT", and push the "Deploy" button.
